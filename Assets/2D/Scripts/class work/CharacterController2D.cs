...
public class CharacterController2D : MonoBehaviour
{
    ...
    void UpdateGroundCollision()
    {
        ...
        if (isGrounded) animator?.SetBool("InAir", false);
    ...
    void Start()
    {
        // Ignore collisions between Player and Barrier layers
    ...
    {
        if (collision.CompareTag("Goal")) // Add the "Goal" tag to your win object
        {
